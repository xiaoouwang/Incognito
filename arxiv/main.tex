...
We present \textbf{Incognito}, a cross-platform desktop application
...
Incognito follows a two-process architecture (Figure~\ref{fig:architecture}).
...
\small
Wang, X. (2026).
\textit{Incognito} (Version 0.2.0) [Computer software].
